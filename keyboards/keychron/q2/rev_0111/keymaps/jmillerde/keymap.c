...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[_ML1] = LAYOUT_ansi_67(
        KC_GRV,  KC_BRID, KC_BRIU, KC_LPAD, KC_MCTL, RGB_VAD, RGB_VAI, KC_MPRV, KC_MPLY, KC_MNXT, KC_MUTE,  KC_VOLD, KC_VOLU,  KC_DEL,         KC_SLEP,
	...
	[_WL1] = LAYOUT_ansi_67(
        ...
        KC_LCAP,   KC_GESC,  KC_LSPO, KC_RSPC, KC_LCPO,  KC_RCPC,  KC_LAPO,  KC_RAPC, RESET,   DEBUG,   KC_NO,     KC_NO,              KC_NO,            KC_PGDN,
        KC_TRNS,             KC_NO,   KC_NO,   KC_NO,    KC_NO,    KC_NO,    KC_NO,   KC_NO,   KC_NO,   KC_NO,     KC_NO,   		   KC_TRNS,  KC_NO,
        KC_TRNS,  KC_TRNS,   KC_TRNS,                              KC_TRNS,                             KC_TRNS,   KC_TRNS,  MO(_RGB), KC_NO,    KC_NO,  KC_NO
	),
	
	[_RGB] = LAYOUT_ansi_67(
        KC_GRV,  KC_F13,   KC_F14,  KC_F15,  KC_F16,  KC_F17,   KC_F18,   KC_F19,   KC_F20,   KC_F21,   KC_F22,   KC_F23,   KC_F24,   KC_DEL,             KC_PWR,
        ...
        KC_TRNS, KC_TRNS,  KC_TRNS,                             KC_NO,                                  MO(_NP),  KC_TRNS,  KC_TRNS,  KC_NO,      KC_NO,  KC_NO
	),
	
	[_NP] = LAYOUT_ansi_67(
        KC_LPRN,   KC_RPRN,  KC_CIRC, KC_PAST, KC_PSLS,  KC_NO,    KC_NO,    KC_NO,   KC_NO,   KC_NO,   KC_NO,      KC_NO,     KC_NO,      KC_NO,          KC_CALC,
        KC_PMNS,   KC_P9,    KC_P8,   KC_P7,   KC_P6,    KC_NO,    KC_NO,    KC_NO,   KC_NO,   KC_NO,   KC_NO,      KC_NO,     KC_NO,      KC_NO,          KC_NLCK,
        KC_PPLS,   KC_P5,    KC_P4,   KC_P3,   KC_P2,    KC_NO,    KC_NO,    KC_NO,   KC_NO,   KC_NO,   KC_NO,      KC_NO,                 KC_NO,		   KC_SLCK,
        KC_PEQL,             KC_P1,   KC_P0,   KC_PDOT,  KC_PCMM,  KC_NO,    KC_NO,   KC_NO,   KC_NO,   KC_NO,      KC_NO,   			   KC_NO,  KC_NO,
